...
d3.csv("Project 2 Employment Data.csv", function (data) {
    for (let counter = 0; counter < data.length; counter++) {
        ...
        let uePercSept2019 = data[counter].2019;
        let uePercJuly2020 = data[counter].UEPercJuly2020;
        let uePercAug2020 = data[counter].UEPercAug2020;
        let uePercSept2020 = data[counter].2020;
        let uePercSept2019Percentile = data[counter].2019Percentile;
        ...
        let uePercSept2020Percentile = data[counter].2020Percentile;
